...
import RecetteFormulaire from "../../Recette/AjoutRecette/RecetteFormulaire";
        ...
        <div className="grid grid-cols-5 gap-1 text-center h-full">
          <div className="col-span-0 border flex flex-col rounded-md">
            <div className="flex flex-col text-slate-50 font-bold">
              <button onClick={toggleShowListRecette}>
                Afficher mes recettes
              </button>
              <button onClick={toggleRecetteFormulaire}>
                Ajouter une recette
              </button>
            </div>
          </div>
          ...
          <ul className="w-full items-center flex place-content-evenly border-2 border-zinc-800 text-zinc-50 font-bold rounded-xl h-20">
            <li>
              <div className="flex flex-col items-center">
                <Link to="/">
                  <BiHome className="mobile:h-5 mobile:w-5 md:hidden" />
                </Link>
                <Link to="/" className="md:text-3xl mobile:hidden">
                  Accueil
                </Link>
              </div>
            </li>
            ...
            <li>
              <div className="flex flex-col items-center relative">
                ...
                >
                  <Link to="/ma-cuisine">Ma cuisine</Link>
                </button>
                {showDropDownCuisine && (
                  <div
                    onMouseLeave={toggleDropDownCuisine}
                    className="flex flex-col absolute top-9 left-0 opacity-80 bg-zinc-800 border-zinc-800 py-2 rounded-md"
                  >
                    <button
                      onClick={toggleShowNavigationMaCuisineFormulaire}
                      className="md:text-2xl mobile:hidden"
                    >
                      Ajouter une recette
                    </button>
                    <button
                      onClick={toggleShowNavigationMaCuisineListe}
                      className="md:text-2xl mobile:hidden"
                    >
                      Afficher mes recettes
                    </button>
              ...
              <div className="flex flex-col items-center relative">
                ...
                {showDropDown && (
                  <div
                    ...
                    className="flex flex-col absolute top-full left-0 opacity-80 bg-zinc-800 border-zinc-800 py-2 rounded-md"
                  >
                    <Link
                      className="block px-4 py-2 text-zinc-50 hover:bg-zinc-200"
                      to="/"
                    >
                      Profil
                    </Link>
