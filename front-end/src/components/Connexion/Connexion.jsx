...
// TODO FORMULAIRE DE CONNEXION
    return (
        <>
        <NavBar />
        <form className='flex flex-col w-5/12 mx-auto h-full
        ...
        mobile:text-3xl 
        md:text-5xl">Connexion</h1>
            <input className="bg-orange-100 rounded-md text-center 
            ...
            type="password"
                   ...
                   name="mdp" />
            <button  className="w-4/12 mx-auto text-slate-200 text-center font-bold rounded-md mt-5 px-8 bg-orange-500 hover:bg-orange-700
